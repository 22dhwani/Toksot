...
const BottomBar = () => {
  return (
    <div className="md:fixed md:bottom-0 lg:relative z-50 w-full lg:h-12 sm:h-20 bg-[#fcfcfc] dark:bg-gray-700 border-t-[1px] border-[#f0f0f0] dark:border-gray-600 mt-24">

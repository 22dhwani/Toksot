  ...
  return (
    <section className="lg:pt-40 lg:pb-24 sm:py-32 xs:py-24 lg:px-28 xl:px-28 xs:px-5  font-oswald bg-black text-white tracking-wider lg:leading-relaxed xs:leading-snug text-3xl ">
      <div className="grid lg:grid-cols-6 xs:grid-cols-1 xl:gap-8 2xl:gap-0">
        ...
        <div className="flex flex-col xl:col-span-4 lg:col-span-3 gap-3 lg:text-left sm:text-center lg:pt-2 xl:pt-10 2xl:pt-2 ">
          <h4 className="font-oswald xs:text-lg lg:text-2xl">Explore</h4>
          <h1 className="font-oswald xl:text-[4.5rem] lg:text-5xl xs:text-5xl tracking-wide xl:leading-tight  lg:leading-snug xs:leading-snug col-span-1 ">
            Explore endless photos of your interests.
          </h1>
        </div>
      </div>
      <div className="grid lg:grid-cols-6 xs:grid-cols-1 items-center lg:gap-10 xs:my-28 ">
        <div className="2xl:pl-6 flex flex-col xl:col-span-4 lg:col-span-3 gap-3 text-right xs:order-2 lg:order-1 xl:mb-16 2xl:mt-[20vh] lg:mt-[8vh] xl:mt-0 lg:text-right sm:text-center ">
